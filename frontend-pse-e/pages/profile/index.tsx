  ...
  return (
    <>
      ...
      <div className={`mt-14 text-center pt-10 ${user ? 'bg-gradient-to-br from-blue-50 to-purple-50' : ''}`}>
        ...
        <footer className="bg-transparent mt-24 py-4">
          <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 sm:text-center">© 2023 <a href="https://writespace.nl/" className="hover:underline">WriteSpace</a>. All Rights Reserved.
            </span>
            <ul className="flex flex-wrap justify-center items-center mt-3 text-sm font-medium text-gray-500 sm:mt-0 text-center">
              <li>
