                ...
                <div className="bg-white border-b border-gray-200 p">
                    <div className="px-4 mx-auto sm:px-6 lg:px-8">
                        <nav className="relative h-16 lg:h-20">
                            ...
                            {showLogout && (
                                <button type="button" className=" absolute -translate-x-0 inset-y-5 right-0 inline-flex p-2 ml-5 text-black transition-all duration-200 rounded-md focus:bg-gray-100 hover:bg-gray-100 items-center" onClick={() => {
                                    logout()
                                }}>
                            ...
                            <Link href="/profile">
                                <button type="button" className=" absolute -translate-x-10 inset-y-5 right-0 inline-flex p-2 ml-5 text-black transition-all duration-200 rounded-md focus:bg-gray-100 hover:bg-gray-100 items-center">
